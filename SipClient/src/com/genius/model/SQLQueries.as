package com.genius.model
{
	public class SQLQueries
	{
		...
		public static var C_STD_BATCH:String = "CREATE TABLE IF NOT EXISTS student_batch ( id INTEGER PRIMARY KEY AUTOINCREMENT, studentid TEXT, batchid TEXT, fees INTEGER, amountpaid INTEGER, discount INTEGER, modifieddate TEXT)";
		public static var S_ALL_BATCH_STUDENTS:String = "select s.id,s.firstname, s.lastname, s.dob, s.contactnumber1, sb.fees, sb.amountpaid, sb.discount from students s inner join student_batch sb on s.id = sb.studentid where sb.batchid = ?"
